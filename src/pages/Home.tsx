...
const features = [
  {
    ...
    description:
      "Enregistrez vos créations en quelques secondes et stockez-les de manière sécurisée.",
  },
  {
    icon: ShieldCheck,
    title: "Empreinte numérique infalsifiable",
    description:
      "Chaque œuvre reçoit une signature cryptographique unique garantissant son authenticité.",
  },
  {
    icon: TrendingUp,
    title: "Détection avancée de plagiat",
    description:
      "Notre IA compare votre œuvre à une base de données et détecte les similarités.",
  },
];
...
const testimonials = [
  {
    ...
    role: "Écrivaine",
    rating: 5,
    text: "Grâce à OeuvreGuard, j'ai enfin un moyen simple de protéger mes écrits.",
  },
  {
    name: "Pierre Zongo",
    role: "Compositeur",
    rating: 4,
    text: "L'interface est claire, rapide et professionnelle.",
  },
  {
    name: "Aïcha Traoré",
    role: "Artiste",
    rating: 5,
    text: "L'analyse de plagiat est bluffante !",
  },
];
...
export default function Home() {
  return (
    <div className="animate-fade-in">
      {/* Hero Section */}
      <section className="bg-[url('/images/oeuvre-guard-hero.png')] bg-cover bg-center text-white py-20">
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Link
              to="/upload"
              className="card p-6 hover:border-[#009639] border-2 border-transparent transition-all"
            >
              ...
              <p className="text-slate-600">
                Ajoutez vos créations dans la base sécurisée pour les protéger
                et les valoriser.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-slate-600">
                Analysez vos œuvres pour détecter les similitudes et éviter les
                copies.
              </p>
            </Link>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-slate-600 text-center mb-12">
            Découvrez pourquoi adopter OeuvreGuard
          </p>
              ...
              <div key={i} className="card p-6">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 rounded-full bg-[#009639]/20 flex items-center justify-center">
                    <span className="font-bold text-[#009639] text-lg">
                      {t.name.charAt(0)}
                    </span>
                  </div>
                  <div>
